...
fun MoviePortraitListPreview() {
    MoviePortraitList(
        ...
        listOf(
            ...
            Movie(2, "Second Title", "Second name", "", "", emptyList(), "", 1.2, 121, false),
            Movie(3, "Second Title", "Second name", "", "", emptyList(), "", 1.2, 121, false),
            Movie(4, "Second Title", "Second name", "", "", emptyList(), "", 1.2, 121, false),
